...
const exampleLayers=[
    ...
    {
      src: 'https://s3.glbimg.com/v1/AUTH_8b29beb0cbe247a296f902be2fe084b6/2025/html/receitas/can/img/can/parallax/dinamica-desk.png',
      alt: 'Apresentadora',
      speedY: -0.05,
      zIndex: 2,
      initialScale: 0.7,
      mobile: {
        src: 'https://s3.glbimg.com/v1/AUTH_8b29beb0cbe247a296f902be2fe084b6/2025/html/receitas/can/img/can/parallax/dinamica-mob.png', // Imagem diferente para mobile
        initialScale: 0.67, // Um pouco menor no mobile para caber melhor
        speedY: 0.15,
      }
    },
    {
